...
class SimpleScanViewController: ScanBaseViewController {
    ...
    // String
    static var descriptionString = "Scan Card"
    static var enableCameraPermissionString = "Enable camera access"
    static var enableCameraPermissionsDescriptionString = "To scan your card you'll need to update your phone settings"
    static var closeButtonString = "Close"
    static var torchButtonString = "Torch"
//    static var privacyLinkString = String.Localized.scanCardExpectedPrivacyLinkText()
    ...
    func setupDenyUi() {
        ...
        let font =
            enableCameraPermissionsButton.titleLabel?.font.withSize(18)
        ...
        enableCameraPermissionsText.text =
            SimpleScanViewController.enableCameraPermissionsDescriptionString
