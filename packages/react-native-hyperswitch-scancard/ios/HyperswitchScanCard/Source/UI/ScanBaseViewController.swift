...
//        self.ocrMainLoop()?.scanStats.permissionGranted = granted
    ...
    //MARK: ANALYTICS ScanAnalyticsManager.shared.logCameraPermissionsTask(success: granted)
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        //MARK: ANALYTICS ScanAnalyticsManager.shared.setScanSessionStartTime(time: Date())
